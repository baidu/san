describe("Component Attribute Inherit", function () {
    ...
    it("1 level", function (done) {
        ...
        expect(span.getAttribute('data-title')).toBe('state:Hahaha');
        ...
        myComponent.nextTick(function () {
            ...
            expect(span.getAttribute('data-title')).toBe('state:Wuwuwu');
    ...
    it("inheritAttrs option to disable attr inherit, include style/class/id", function (done) {
        ...
        expect(span.hasAttribute('data-title')).toBeFalsy();
    ...
    it("inner component has $attrs data, not has attrXxx data", function (done) {
        ...
        expect(innAttrs['data-title']).toBe('state:Hahaha');
        ...
        myComponent.nextTick(function () {
            ...
            expect(innAttrs['data-title']).toBe('state:Wuwuwu');
