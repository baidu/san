...
var PRODUCTION_TYPE_CHECKER = createChainableChecker(empty);

/* eslint-disable fecs-valid-var-jsdoc */
var DataTypes = {
    any: PRODUCTION_TYPE_CHECKER,
    array: PRODUCTION_TYPE_CHECKER,
    object: PRODUCTION_TYPE_CHECKER,
    func: PRODUCTION_TYPE_CHECKER,
    string: PRODUCTION_TYPE_CHECKER,
    number: PRODUCTION_TYPE_CHECKER,
    bool: PRODUCTION_TYPE_CHECKER,
    symbol: PRODUCTION_TYPE_CHECKER,
    arrayOf: PRODUCTION_TYPE_CHECKER,
    instanceOf: PRODUCTION_TYPE_CHECKER,
    shape: PRODUCTION_TYPE_CHECKER,
    oneOf: PRODUCTION_TYPE_CHECKER,
    oneOfType: PRODUCTION_TYPE_CHECKER,
    objectOf: PRODUCTION_TYPE_CHECKER,
    exact: PRODUCTION_TYPE_CHECKER
};
