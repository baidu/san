...
+ 【bug修复】- s-bind 对应的数据在 undefined/null 和 Object 之间切换时，运行出错
+ 【bug修复】- s-is 无法使用方法调用表达式
+ 【bug修复】- 在非 Web 的视图场景，热点元素的预热机制可能导致视图元素创建失败
...
+ 【bug修复】- 组件反解时，Date 类型数据恢复错误


3.15.1  (2024-11-7)
-------

+ 【bug修复】- 在和 if、is、for 指令同时使用时，attribute 组件透传功能失效
